        ...
        <div class="grid md:grid-cols-2 gap-4 md:gap-8 xl:gap-20 md:items-center">
            <div>
                <h1 class="block text-3xl font-bold text-gray-800 sm:text-4xl lg:text-6xl lg:leading-tight dark:text-white">
                    <span class="text-orange-500 dark:text-orange-600">Debug Lab</span>
                    Skills Learning Center
                </h1>
                <p class="mt-3 text-lg text-gray-800 dark:text-gray-400">Debug Lab is a skill learning center for
                    children aged 7-17 to come together to learn, train and master their skills in technology
                    for better future.</p>

                <!-- Buttons -->
                <div class="mt-7 grid gap-3 w-full sm:inline-flex">
                    <a class="py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-orange-500 text-white hover:bg-orange-600 disabled:opacity-50 disabled:pointer-events-none dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600 dark:bg-orange-800 dark:hover:bg-orange-700"
                        href="https://forms.gle/2V9yJhV2zKYsVjnz5" target="_blank">
            ...
            <div class="relative ms-4">
                <nuxt-img format="webp" class="w-full rounded-md" src="~/assets/img/hero.png" alt="Image Description" />
                    <div
