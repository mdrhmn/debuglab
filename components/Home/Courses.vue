        ...
        <div class="relative p-6 md:p-16">
            ...
            <div class="relative z-10 lg:grid lg:grid-cols-12 lg:gap-16 lg:items-center">
                <div class="mb-10 lg:mb-0 lg:col-span-6 lg:col-start-8 lg:order-2">
                    <h2 class="text-2xl font-bold md:text-4xl md:leading-tight dark:text-white">See Our <span
                            class="text-orange-500 dark:text-orange-600">Courses</span></h2>
                    <p class="mt-1 text-gray-600 dark:text-gray-400">Whatever your status, our center evolve according
                        to your
                        needs.</p>
                    ...
                    <nav class="grid gap-4 mt-5 md:mt-10" aria-label="Tabs" role="tablist">
                        <button type="button"
                            ...
                            role="tab">
                            <span class="flex">
                                <svg class="flex-shrink-0 mt-2 h-6 w-6 md:w-7 md:h-7 hs-tab-active:text-orange-600 text-gray-800 dark:hs-tab-active:text-orange-500 dark:text-gray-200"
                                ...
                                <span class="grow ms-6">
                                    <span
                                        class="block text-lg font-semibold hs-tab-active:text-orange-600 text-gray-800 dark:hs-tab-active:text-orange-500 dark:text-gray-200">CS
                                        Fundamental Skills</span>
                                    <span
                                        class="block mt-1 text-gray-800 dark:hs-tab-active:text-gray-200 dark:text-gray-200">
                                        Discover how to program a computer through coding by creating games and
                                        interactive stories and become an expert in a programming language.</span>
                                </span>
                            </span>
                        </button>
                        ...
                        <button type="button"
                            ...
                            <span class="flex">
                                ...
                                <span class="grow ms-6">
                                    <span
                                        class="block text-lg font-semibold hs-tab-active:text-orange-600 text-gray-800 dark:hs-tab-active:text-orange-500 dark:text-gray-200">3D
                                        Animation</span>
                                    <span
                                        class="block mt-1 text-gray-800 dark:hs-tab-active:text-gray-200 dark:text-gray-200">Discover
                                        how to create an animation movie like Minions and more
                                        by developing your own unique 3D model and scene.</span>
                                </span>
                            </span>
                        </button>
                        ...
                        <button type="button"
                            ...
                            <span class="flex">
                                ...
                                <span class="grow ms-6">
                                    <span
                                        class="block text-lg font-semibold hs-tab-active:text-orange-600 text-gray-800 dark:hs-tab-active:text-orange-500 dark:text-gray-200">Web
                                        & Game Development</span>
                                    <span
                                        class="block mt-1 text-gray-800 dark:hs-tab-active:text-gray-200 dark:text-gray-200">
                                        Become a webmaster and turn any idea into an online environment by learning how
                                        to design a simple web page and a game app and create
                                        immersive, interactive experiences.</span>
                                </span>
                            </span>
                        </button>
                        ...
                        <button type="button"
                            ...
                            <span class="flex">
                                ...
                                <span class="grow ms-6">
                                    <span
                                        class="block text-lg font-semibold hs-tab-active:text-orange-600 text-gray-800 dark:hs-tab-active:text-orange-500 dark:text-gray-200">3D
                                        Printing & Modelling</span>
                                    <span
                                        class="block mt-1 text-gray-800 dark:hs-tab-active:text-gray-200 dark:text-gray-200">
                                        A great way to introduce children to the creation of prototypes in technology
                                        and engineering and improve their
                    ...
                    <div class="relative">
                        ...
                        <div>
                            <div id="tabs-with-card-1" role="tabpanel" aria-labelledby="tabs-with-card-item-1">
                                <img format="webp" data-sizes="auto" class="lazyload shadow-xl shadow-gray-200 rounded-xl dark:shadow-gray-900/[.2]"
