<template>
    <NotificationGroup group="foo">
        <div class="fixed z-50 inset-0 flex items-start justify-end p-6 px-4 py-6 pointer-events-none">
                        ...
                        <div class="max-w-xs bg-white border rounded-md shadow-lg dark:bg-gray-800 dark:border-gray-700"
                            ...
                            <div class="flex p-4">
                                <div class="flex-shrink-0">
                                    ...
                                    <svg v-else-if="notification.type === 'success'" class="h-4 w-4 text-green-500 mt-0.5"
                                        xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                        viewBox="0 0 16 16">
                                        <path
                                    ...
                                    <svg v-else-if="notification.type === 'warning'" class="h-4 w-4 text-orange-500 mt-0.5"
                                        xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                        viewBox="0 0 16 16">
                                        <path
                                    ...
                                    <svg v-else-if="notification.type === 'error'" class="h-4 w-4 text-red-500 mt-0.5"
                                        xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                        viewBox="0 0 16 16">
                                        <path
